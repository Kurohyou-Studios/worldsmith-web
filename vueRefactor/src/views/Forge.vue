...
import { Button,ForgeToolbar,ProjectEntry } from '@/components';
...
const { worlds } = storeToRefs(dataStore);
const buttonRows = [
  [
...
<div class="forge">
  ...
  <nav class="forge-sidebar">
    <ul>
      <ProjectEntry v-for="obj in worlds" :key="obj.id || obj.name" level="4" type="Project" :data="obj" :project="obj" name-prop="name" :content="obj.name || 'new project'"></ProjectEntry>
      <li class="cover-marker">
        <Button class="flex-box hover-expand text-4 justify-content-center" @click="createProject">
          <span class="hover-expand">
            <span class="material-icons">add</span>
            <span class="full-text">create</span>
          </span>
        </Button>
      </li>
    </ul>
