...
export class Planet extends SO{
   ...
   */
  constructor({name = 'New Planet',mass = 1,density = 5.51,tilt = 23.5,period = 24,albedo = 0.306,greenhouse = 1,distance = 1,eccentricity = 0,inclination = 0,pressure = 1,gasPercent,creation,id }){
